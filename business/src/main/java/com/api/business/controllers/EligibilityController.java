...
public class EligibilityController {
    ...
    public EligibilityResponse verifyEligibility(@Valid EligibilityRequest eligibilityRequest, @RequestParam String spokesmanDocument) {
        ...
        boolean isEligible = eligibilityService.verifyEligibility(eligibilityRequest);
